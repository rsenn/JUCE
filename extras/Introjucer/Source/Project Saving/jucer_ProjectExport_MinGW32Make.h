...
class MinGW32ProjectExporter  : public ProjectExporter
{
public:
    //==============================================================================
    static const char* getName()           { return "MinGW32 Makefile"; }
    static const char* getValueTreeTypeName()   { return "MINGW32_MAKE"; }

    static MinGW32ProjectExporter* createForSettings (Project& project, const ValueTree& settings)
    {
        if (settings.hasType (getValueTreeTypeName()))
            return new MinGW32ProjectExporter (project, settings);
    ...
    //==============================================================================
    MinGW32ProjectExporter (Project& p, const ValueTree& t)   : ProjectExporter (p, t)
    {
        name = getName();

        if (getTargetLocationString().isEmpty())
            getTargetLocationValue() = getDefaultBuildsRootFolder() + "MinGW32Makefile";
    ...
    bool isMinGW32Makefile() const override               { return true; }
...
protected:
    //==============================================================================
    class MinGW32BuildConfiguration  : public BuildConfiguration
    {
    public:
        MinGW32BuildConfiguration (Project& p, const ValueTree& settings, const ProjectExporter& e)
    ...
    {
        return new MinGW32BuildConfiguration (project, tree, *this);
    }
...
private:
    ...
    {
        if (const MinGW32BuildConfiguration* makeConfig = dynamic_cast<const MinGW32BuildConfiguration*> (&config))
    ...
    JUCE_DECLARE_NON_COPYABLE (MinGW32ProjectExporter)
};
